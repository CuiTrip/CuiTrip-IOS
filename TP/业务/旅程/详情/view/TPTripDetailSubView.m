...
- (void)layoutSubviews
{
    ...
    self.contactBtn.frame = CGRectMake((self.frame.size.width - 105.0f) / 2, self.nameLabel.vzBottom + 10.0f, 105.0f, 44.0f);
    self.titleLabel.frame = CGRectMake(0.0f, self.contactBtn.vzBottom + 30.0f, self.frame.size.width, 18.0f);
