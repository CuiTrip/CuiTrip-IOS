...
//    [self.view addSubview:navigationBar];
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(clickLeftButton) ];
    [self.navigationItem setTitle:NSLocalizedString(@"countrychoose", nil)];
    
    search=[[UISearchBar alloc] init];
    search.frame=CGRectMake(0, 0, self.view.frame.size.width, 44);
    [self.view addSubview:search];
    
    table=[[UITableView alloc] initWithFrame:CGRectMake(0, 44, self.view.frame.size.width, self.view.bounds.size.height-(88)) style:UITableViewStylePlain];
