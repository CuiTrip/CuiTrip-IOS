...
void drawGlossAndGradient(CGContextRef context, CGRect rect, UIColor* startColor,
                          UIColor* endColor)
{
    tbcity_drawLinearGradient(context, rect, startColor, endColor);
    ...
    tbcity_drawLinearGradient(context, topHalf, glossColor1, glossColor2);
}
...
void drawSolideHeartInRect(CGContextRef context, CGRect rect, UIColor* heartColor,BOOL filled)
{
    ...
    CGContextSaveGState(context);
    CGContextSetStrokeColorWithColor(context, heartColor.CGColor);
...
void drawSolidRoundCornerForRect(CGContextRef context, CGRect rect, CGFloat radius, UIColor* fillColor,UIColor* shadowColor)
{
    ...
    //right upper corner
    CGPathAddArcToPoint(path, NULL, CGRectGetMaxX(rect)+0.5, CGRectGetMinY(rect)+0.5,
                        CGRectGetMaxX(rect)+0.5, CGRectGetMaxY(rect)+0.5, radius);
    //right lower corner
    CGPathAddArcToPoint(path, NULL, CGRectGetMaxX(rect)+0.5, CGRectGetMaxY(rect)+0.5,
                        CGRectGetMinX(rect)+0.5, CGRectGetMaxY(rect)+0.5, radius);
    //lower left corner
    CGPathAddArcToPoint(path, NULL, CGRectGetMinX(rect)+0.5, CGRectGetMaxY(rect)+0.5,
                        CGRectGetMinX(rect)+0.5, CGRectGetMinY(rect)+0.5, radius);
    
    //upper left corner
    CGPathAddArcToPoint(path, NULL, CGRectGetMinX(rect)+0.5, CGRectGetMinY(rect)+0.5,
                        CGRectGetMaxX(rect)+0.5, CGRectGetMinY(rect)+0.5, radius);
